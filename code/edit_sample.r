...
FixSample = function(sample,
                     s1 = '/home/rodox/git/commercial_model/seed/seed_split_bank.epJSON',
                     s2 = '/home/rodox/git/commercial_model/seed/seed_vrf_bank.epJSON') {
...
# application ####
EditSample('/home/rodox/git/commercial_model/code/sample.csv')